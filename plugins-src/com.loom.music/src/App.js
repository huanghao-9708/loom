          ...
          <div class="flex-1 flex overflow-hidden">
             ...
             <div class="w-56 border-r border-border-light bg-bg-secondary flex flex-col select-none shrink-0">
                ...
                <div class="flex-1 overflow-y-auto px-3 py-4 space-y-5">
                    <div class="space-y-0.5 text-[13px] font-medium">
                        ...
                        <div @click="navigate('albums')" :class="['px-3 py-2 rounded-lg cursor-pointer transition flex items-center gap-3', currentRoute.name === 'albums' ? 'bg-white text-text-primary shadow-sm' : 'text-text-secondary hover:bg-gray-100 hover:text-text-primary']">
             ...
             <!-- Center Main Content -->
              <div class="flex-1 flex flex-col min-w-0">
                ...
                <albums-view v-if="currentRoute.name === 'albums'"></albums-view>
